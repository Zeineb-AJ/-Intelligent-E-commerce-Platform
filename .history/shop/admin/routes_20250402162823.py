...
def admin():
    ...
    page = request.args.get('page', 1, type=int)  # Récupérer le numéro de page
    products = Product.query.paginate(page=page, per_page=8)  # Limiter à 8 produits par page

    return render_template("admin/login.html", title="Admin Page", products=products)
