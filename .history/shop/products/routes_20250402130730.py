...
def place_order():
    ...
    db.session.commit()  # Il est important de commettre ici pour générer l'ID de la commande
    ...
    db.session.commit()  # Commit pour valider la commande et les items

    session["cart"] = {}  # Vider le panier après l'achat
