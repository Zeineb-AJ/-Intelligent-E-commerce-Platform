...
def confirm_order():
    ...
    # Créer une nouvelle commande dans la table Order
    new_order = Order(
        ...
        created_at=datetime.utcnow()  # Date et heure actuelles
    )
    ...
    return redirect(url_for('cart'))  # Redirection vers la page du panier (ou une autre page)
def get_all_brands():
