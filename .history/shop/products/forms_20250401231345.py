...
from wtforms import DecimalField  # Importer DecimalField

class AddProducts(FlaskForm):
    name = StringField("Name", [validators.DataRequired()])
    price = DecimalField("Price:RS", [validators.DataRequired()], places=2)  # Change IntegerField en DecimalField
